/* 
   ...
   Purpose:         "Modify your program from Practice Program 3 to also display the name of
...
int main(int argc, char** argv) {
    ...
    if ((mth==MAR && dte>=21)||(mth==APR && dte<=19))
    {
        ...
        if (mth==MAR && dte<=23)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<ta<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<fi<<endl;
        cout<<"You are most compatible with "<<ar<<", "<<le<<", and "<<sa<<"."<<endl;
    }
    ...
    else if ((mth==APR && dte>=20)||(mth==MAY && dte<=20))
    {
        ...
        if (mth==APR && dte<=22)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<ge<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<ea<<endl;
        cout<<"You are most compatible with "<<ta<<", "<<vi<<", and "<<cp<<"."<<endl;
    }
    ...
    else if ((mth==MAY && dte>=21)||(mth==JUN && dte<=21))
    {
        ...
        if (mth==MAY && dte<=23)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<ca<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<ai<<endl;
        cout<<"You are most compatible with "<<ge<<", "<<li<<", and "<<aq<<"."<<endl;
    }
    ...
    else if ((mth==JUN && dte>=22)||(mth==JUL && dte<=22))
    {
        ...
        if (mth==JUN && dte<=24)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<le<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<wa<<endl;
        cout<<"You are most compatible with "<<ca<<", "<<sc<<", and "<<pi<<"."<<endl;
    }
    ...
    else if ((mth==JUL && dte>=23)||(mth==AUG && dte<=22))
    {
        ...
        if (mth==JUL && dte<=25)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<vi<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<fi<<endl;
        cout<<"You are most compatible with "<<le<<", "<<ar<<", and "<<sa<<"."<<endl;
    }
    ...
    else if ((mth==AUG && dte>=23)||(mth==SEP && dte<=22))
    {
        ...
        if (mth==AUG && dte<=25)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<li<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<ea<<endl;
        cout<<"You are most compatible with "<<vi<<", "<<ta<<", and "<<cp<<"."<<endl;
    }
    ...
    else if ((mth==SEP && dte>=23)||(mth==OCT && dte<=22))
    {
        ...
        if (mth==SEP && dte<=25)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<sc<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<ai<<endl;
        cout<<"You are most compatible with "<<li<<", "<<ge<<", and "<<aq<<"."<<endl;
    }
    ...
    else if ((mth==OCT && dte>=23)||(mth==NOV && dte<=21))
    {
        ...
        if (mth==OCT && dte<=25)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<sa<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<wa<<endl;
        cout<<"You are most compatible with "<<sc<<", "<<ca<<", and "<<pi<<"."<<endl;
    }
    ...
    else if ((mth==NOV && dte>=22)||(mth==DEC && dte<=21))
    {
        ...
        if (mth==NOV && dte<=24)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<cp<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<fi<<endl;
        cout<<"You are most compatible with "<<sa<<", "<<ar<<", and "<<le<<"."<<endl;
    }
    ...
    else if ((mth==DEC && dte>=22)||(mth==JAN && dte<=19))
    {
        ...
        if (mth==DEC && dte<=24)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<aq<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<ea<<endl;
        cout<<"You are most compatible with "<<cp<<", "<<ta<<", and "<<vi<<"."<<endl;
    }
    ...
    else if ((mth==JAN && dte>=20)||(mth==FEB && dte<=18))
    {
        ...
        if (mth==JAN && dte<=22)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<pi<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<ai<<endl;
        cout<<"You are most compatible with "<<aq<<", "<<ge<<", and "<<li<<"."<<endl;
    }
    ...
    else if ((mth==FEB && dte>=19)||(mth==MAR && dte<=20))
    {
        ...
        if (mth==FEB && dte<=22)
            ...
            cout<<"You birthday is on a \"cusp\". Your adjacent sign is "<<ar<<"."<<endl<<endl;
        
        cout<<"Your element is: "<<wa<<endl;
        cout<<"You are most compatible with "<<pi<<", "<<ca<<", and "<<sc<<"."<<endl;
    }
